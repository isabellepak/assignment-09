...
missing_percentages = (sales_df.isna().sum() / len(sales_df)) * 100
...
print("1. Increase promotions on high-performing products like PhoneX to boost revenue further.")
print("2. Focus inventory on top-performing regions like North America and Europe.")
print("3. Address missing pricing and unit data to improve accuracy in future analysis.")